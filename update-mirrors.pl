...
my %m = (
	...
	mirror020 => {
        ...
        mirror044 => {
            ...
            ipv6 => "False",
            loadBalanced => "No",
            httpWebsiteMirror => "http://www.torproject.nl/",
            httpsWebsiteMirror => "https://www.torproject.nl/",
            rsyncWebsiteMirror => "",
            ftpWebsiteMirror => "",
            httpDistMirror => "http://www.torproject.nl/dist/",
        ...
        mirror046 => {
            ...
            ipv6 => "False",
            loadBalanced => "No",
            httpWebsiteMirror => "http://mirror.open-networx.org/torproject.org/",
            httpsWebsiteMirror => "https://mirror.open-networx.org/torproject.org/",
            rsyncWebsiteMirror => "",
            ftpWebsiteMirror => "",
            httpDistMirror => "http://mirror.open-networx.org/torproject.org/dist/",
        ...
        mirror055 => {
            ...
            ipv6 => "True",
            loadBalanced => "No",
            httpWebsiteMirror => "http://tor.unregistered.eu/",
            httpsWebsiteMirror => "",
            rsyncWebsiteMirror => "",
            ftpWebsiteMirror => "",
            httpDistMirror => "http://tor.unregistered.eu/dist/",
            httpsDistMirror => "",
            rsyncDistMirror => "",
            hiddenServiceMirror => "",
        },
        ...
        mirror057 => {
            ...
            rsyncWebsiteMirror => "",
            ftpWebsiteMirror => "",
            httpDistMirror => "http://5coluna.com/downloads/tor/",
            httpsDistMirror => "https://5coluna.com/downloads/tor/",
            rsyncDistMirror => "",
            hiddenServiceMirror => "",
        },
        mirror058 => {
        ...
        mirror060 => {
            ...
            ipv6 => "True",
            loadBalanced => "No",
            httpWebsiteMirror => "http://tor.dearstar.net/",
            httpsWebsiteMirror => "",
            rsyncWebsiteMirror => "",
            ftpWebsiteMirror => "",
            httpDistMirror => "http://tor.dearstar.net/dist/",
            httpsDistMirror => "",
            rsyncDistMirror => "",
            hiddenServiceMirror => "",
        }
